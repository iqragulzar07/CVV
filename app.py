...
st.set_page_config(
    page_title="Iqra Gulzar | Portfolio",
    page_icon="🤖",
    layout="centered"
)

# 2. Ultimate High-Visibility CSS (Neural Dashboard Theme)
st.markdown("""
<style>
...
# 3. Main Header (Based on Screenshot Layout)
...
with col1:
    ...
    if Path(img_path).exists():
        ...
        st.image("iqra_profile_pic_1778410587478.png", width=220)
    else:
        st.write("📷 Photo")

st.markdown('<h1 style="margin-top: 1rem;">IQRA GULZAR</h1>', unsafe_allow_html=True)

st.markdown(f"""
    <p style="font-weight: 700; font-size: 1.1rem; margin-bottom: 2rem;">
        📍 Abu Dhabi, UAE  •  
